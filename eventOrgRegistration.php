...
<html lang="en">
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>     
		...
		<title>Event Organiser registration</title>
	</head>
	<body>
		<?php
...
<div class="container">
        ...
        <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
        	<div class="panel panel-default">
        		<div class="panel-heading">
			    		<h3 class="panel-title"><center>Sign up as event organiser</center> </h3>
			 			</div>
			 			<div class="panel-body">
			    			...
			    			<div class="form-group">
			    				...
			    				<input type="email" name="email" id="email" class="form-control input-sm" placeholder="Email Address" value="<?php echo htmlspecialchars($_POST['email']); ?>" required><?php echo "<p class='text-danger'>$errEmail</p>";?>
			    		    </div>
			    			</div>
			    			</div>
			    			...
			    			<div class="row">
			    		        ...
			    		        <span class="input-group-addon">Password</span>
			    						<input type="password" name="user_password" id="user_password" class="form-control input-sm" placeholder="Password" minlength="6" value="<?php echo htmlspecialchars($_POST['user_password']);  ?>" required>
			    					</div>
			    					</div>
			    				</div>
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			    						...
			    						<input type="password" name="confirm" id="confirm" class="form-control input-sm" placeholder="Confirm Password" minlength="6" value="<?php echo htmlspecialchars($_POST['confirm']); ?>" required>
			    			...
			    			<input type="submit" value="Register" id="submit" name="submit" class="btn btn-info center-block">
			    		
			    		</form>
						 <small><a href="loginpage.php">Already registered?</a></small>
			    	</div>
	    		</div>
    		</div>
    	</div>
  ...
  mysqli_close($connection); ?> 
    ...
    </html> <?php echo "<p class='text-danger'>$errMessage </p>";?>
